...
# The Comments RESTful service.
#
# Supports creating a new comment for a term and fetching all comments for a
# term.  Works with the rest_handler.RestProtoJsonRoute adapter.
